...
-- AS
-- BEGIN
--     DECLARE @_course CHAR(4)
--     SELECT @_course=cnum FROM sections,inserted WHERE sections.secnum=inserted.secnum 
--     PRINT @_course
--     -- BEGIN
--     --     PRINT '不是指定出版社，不能订购!'
--     --     ROLLBACK
...
-- INSERT into sc (snum)
-- UPDATE sc SET secnum='12002' WHERE snum='s001' and secnum='12601'
UPDATE sc SET secnum='12601' WHERE snum='s001' and secnum='12601'
