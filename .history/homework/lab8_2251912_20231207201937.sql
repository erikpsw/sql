...
AS
BEGIN
    DECLARE @_snum CHAR(4),@_inserted_course CHAR(4)
    ...
    FETCH NEXT FROM course_cursor INTO @cnum, @cname;
...
-- INSERT into sc (snum)
UPDATE sc SET secnum='12002' WHERE snum='s001' and secnum='12001' and
